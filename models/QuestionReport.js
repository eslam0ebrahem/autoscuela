...
const questionReportSchema = new mongoose.Schema(
  {
    ...
    status: { type: String, enum: ['pending', 'reviewed', 'fixed', 'dismissed'], default: 'pending', index: true },
...
export default mongoose.models.QuestionReport || mongoose.model('QuestionReport', questionReportSchema)
