  ...
  return (
    <div className="card glass">
      <h3 className="font-bold text-ink dark:text-white mb-6 flex items-center gap-2">
        <span>📈</span> {t('Tu Actividad', 'Your Activity')}
      </h3>
  ...
  const content = (
    <div className={`card-hover h-full flex flex-col gap-4 border-b-4 ${color} ${disabled ? 'opacity-60 grayscale' : ''}`}>
      <div className="flex items-start justify-between">
        <div className="w-12 h-12 rounded-2xl flex items-center justify-center text-2xl bg-white dark:bg-slate-700 shadow-inner">
    ...
    <div className="space-y-6 animate-fade-in pb-8">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          {streak > 0 && (
            <div className="w-12 h-12 md:w-14 md:h-14 bg-orange-50 dark:bg-orange-900/20 rounded-2xl flex items-center justify-center text-xl md:text-2xl border border-orange-100 dark:border-orange-800/50 shadow-sm streak-flame">
              🔥
            </div>
          )}
        </div>
        ...
        <div className="card glass flex flex-col justify-between">
           <div className="flex items-center justify-between mb-6">
             <h3 className="font-bold text-ink dark:text-white flex items-center gap-2">
               <span>🏆</span> {t('Ranking Global', 'Global Ranking')}
             </h3>
