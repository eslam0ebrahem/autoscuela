...
6. Provide "study_tips" as 2-3 specific, actionable tips tailored to their data (as array of strings).
7. Return "topic_priority_order" as array of topic names ranked by impact on readiness score.
8. You MUST return ONLY valid JSON. Do not include markdown formatting like \`\`\`json or any conversational text outside the JSON object.
