...
2. Identify the top 2–3 "weak_topics" based on low accuracy AND high average time taken. Use the user's preferred language for these display names.
...
7. In "recommended_action.filters", you MUST use the Spanish "tag" field values (e.g., "Velocidad") as these act as internal IDs, regardless of the user's language.
8. Return "topic_priority_order" as an array of the Spanish "tag" values ranked by impact.
9. You MUST return ONLY valid JSON. No markdown fences, no prose outside the JSON object.
...
Expected output shape (all keys required):
{
  ...
  "coach_message": "...",
  "recommended_action": { "type": "custom_exam", "filters": ["Velocidad", "Señales"] },
  "predicted_ready_date": "2026-04-15",
  "improvement_rate": 2.3,
  "study_tips": ["Focus on...", "Try practicing...", "Remember to..."],
  "topic_priority_order": ["Velocidad", "Prioridad"]
}`
