...
export async function getUserSkillProfile(userId) {
  ...
  // Use lifetime volume for thresholds, recent accuracy for performance
  ...
  // Determine overall skill level based on lifetime volume and recent accuracy
  ...
  for (const tag of allTags) {
    ...
    const attempted = lifetimeStat.attempted || 0
    const correct = lifetimeStat.correct || 0
