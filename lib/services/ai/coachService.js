...
Return ONLY valid JSON with:
{
  ...
  "tip": "A highly specific, actionable, and UNIQUE study hack or mnemonic. Vary your topics and do not repeat generic advice.",
...
export async function getExamRecommendation({ recentStats, skillProfile = null, studyTrends = null, lang = 'es', sessionId = null }) {
