    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-canvas">
        <div className="text-center">
          ...
          <div className="text-ink-light font-medium">Cargando...</div>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="card max-w-md w-full text-center animate-scale-in">
        ...
        <div className="bg-blue-50 rounded-xl p-4 mb-6">
          <div className="text-3xl font-bold text-primary mb-1">€9.99<span className="text-sm font-normal text-ink-light">/mes</span></div>
